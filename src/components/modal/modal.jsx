...
export default function Modal({
    ...
    setName, setAddress, setPincode, setPhoneNumber,
    buyNow
}) {
                                            ...
                                            <div className="w-full rounded-lg md:mt-0 sm:max-w-md xl:p-0">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <button
                                                        ...
                                                        type="button"
                                                        className="focus:outline-none w-full text-white bg-violet-600 hover:bg-green-700 font-medium rounded-lg text-sm px-5 py-2.5"
                                                    >
                                                        Order Now
                                                    </button>
                                                </div>
